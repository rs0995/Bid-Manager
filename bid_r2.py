...
class ProjectsPage(QWidget):
    ...
    select_sql = "SELECT id, title, description, client_name, project_value, prebid, deadline FROM projects"
    ...
    def __init__(self, controller):
        ...
        self.manage_cols_btn = QPushButton("Manage Columns")

        self.new_btn.clicked.connect(self.open_create_project)
        self.open_btn.clicked.connect(self.open_selected)
        self.delete_btn.clicked.connect(self.delete_selected)
        self.manage_cols_btn.clicked.connect(self.open_manage_columns_dialog)
        for b in (self.new_btn, self.open_btn, self.delete_btn, self.manage_cols_btn):
            b.setProperty("compact", True)
            b.setFixedHeight(34)
        self.new_btn.setMinimumWidth(126)
        self.open_btn.setMinimumWidth(118)
        self.delete_btn.setMinimumWidth(122)
        self.manage_cols_btn.setMinimumWidth(130)

        bar.addWidget(self.search_edit, 1)
        bar.addWidget(self.new_btn)
        bar.addWidget(self.manage_cols_btn)
        bar.addStretch(1)
